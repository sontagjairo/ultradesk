...
hbb_name = 'ultradesk' + ('.exe' if windows else '')
...
def generate_control_file(version):
    ...
    content = """Package: ultradesk
Section: net
Priority: optional
Version: %s
Architecture: %s
Maintainer: Ultra Informatica e Assessoria <contato@ultra.local>
Homepage: https://ultra.local
