...
lazy_static::lazy_static! {
    pub static ref ORG: RwLock<String> = RwLock::new("br.com.ultra".to_owned());
}
...
lazy_static::lazy_static! {
    ...
    pub static ref PROD_RENDEZVOUS_SERVER: RwLock<String> = RwLock::new("72.61.34.20".to_owned());
    pub static ref EXE_RENDEZVOUS_SERVER: RwLock<String> = Default::default();
    pub static ref APP_NAME: RwLock<String> = RwLock::new("Ultra Desk".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["72.61.34.20"];
pub const RS_PUB_KEY: &str = "JPvB567qZohsGYjOlh71CxKSekfb6S6OjGSEbSnZIBw=";
